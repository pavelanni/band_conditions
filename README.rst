...
This skill report current conditions on Amateur Radio bands
...
Alternatively you can use the ``pipenv`` tool with the provided ``Pipfile``. More about ``pipenv``
and how to use it you can find at `this excellent page by Kenneth Ritz`_
...
.. _this excellent page by Kenneth Ritz: http://pipenv.readthedocs.io/en/latest/
...
#. Launch the server by invoking ``python band_conditions.py``.
